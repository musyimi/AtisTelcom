...
import com.atis.admin.FileUploadUtil;
...
public class SettingController {
	...
	public String savedGeneralSettings(@RequestParam("fileImage") MultipartFile multipartFile, HttpServletRequest request, RedirectAttributes ra) throws IOException {
