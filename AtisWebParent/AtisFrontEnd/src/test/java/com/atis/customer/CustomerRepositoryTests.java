...
public class CustomerRepositoryTests {
	...
	public void testCreateCustomer1() {
		...
		customer.setFirstName("ledama");
		customer.setLastName("okina");
		customer.setPassword("password23");
		customer.setEmail("davidftaine@gmail.com");
		customer.setPhoneNumber("312-466-7518");
		customer.setAddressLine1("1927  West Drive");
		customer.setCity("Sacramento");
		customer.setCounty("California");
	...
	public void testCreateCustomer2() {
		...
		customer.setCounty("Maharashtra");
	...
	public void testUpdateAuthenticationType() {
		Integer id = 4;
		repo.updateAthenticationType(id, AuthenticationType.FACEBOOK);
